...
#import "SegmNaviBarController.h"
#import "HCTabPage.h"
#import "PageTableViewController.h"

@interface SegmNaviBarController ()<HCTabPageViewDataSource, HCTabPageViewDelegate>
@property (nonatomic, weak) HCTabPageView *tabPageView;
@end

@implementation SegmNaviBarController
- (HCTabPageView *)tabPageView
{
    if (_tabPageView == nil) {
        HCTabPageView *tabPageView = [[HCTabPageView alloc] initWithBarStyle:TabPageSegmNaviBar];
